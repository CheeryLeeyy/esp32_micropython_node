...
class SGP30:
    ...
    def __init__(self, sdapin, sclpin, address=_SGP30_DEFAULT_I2C_ADDR):
        """Initialize the sensor, get the serial # and verify that we found a proper SGP30"""
        # self._i2c = I2C(sda=Pin(sdapin), scl=Pin(sclpin), freq=100000)
        self._i2c = SoftI2C(sda=Pin(sdapin), scl=Pin(sclpin), freq=100000)
        self._addr = address
